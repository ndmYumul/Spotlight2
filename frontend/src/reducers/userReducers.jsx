import {
    ...
    USER_CREATE_REQUEST, USER_CREATE_SUCCESS, USER_CREATE_FAIL, USER_CREATE_RESET,
    USER_REGISTER_REQUEST, USER_REGISTER_SUCCESS, USER_REGISTER_FAIL,
    USER_SCHEDULE_UPDATE_REQUEST, USER_SCHEDULE_UPDATE_SUCCESS, USER_SCHEDULE_UPDATE_FAIL, USER_SCHEDULE_UPDATE_RESET,
    USER_UPDATE_TO_PRO_REQUEST, USER_UPDATE_TO_PRO_SUCCESS, USER_UPDATE_TO_PRO_FAIL, USER_UPDATE_TO_PRO_RESET,
...
export const userCreateReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case USER_CREATE_SUCCESS: return { loading: false, success: true, user: action.payload }
        case USER_CREATE_FAIL: return { loading: false, error: action.payload }
        case USER_CREATE_RESET: return {}
        default: return state
    }
}
...
export const userRegisterReducer = (state = {}, action) => {
    switch (action.type) {
        ...
        case USER_LOGOUT:
            return {} // Wipe registration data on logout
...
export const userScheduleUpdateReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_SCHEDULE_UPDATE_REQUEST:
            return { loading: true }
        case USER_SCHEDULE_UPDATE_SUCCESS:
            return { loading: false, success: true, scheduleInfo: action.payload }
        case USER_SCHEDULE_UPDATE_FAIL:
            return { loading: false, error: action.payload }
        case USER_SCHEDULE_UPDATE_RESET:
            return {}
        default:
            return state
    }
...
export const userUpdateToProReducer = (state = {}, action) => {
    switch (action.type) {
        case USER_UPDATE_TO_PRO_REQUEST:
            return { loading: true }
        case USER_UPDATE_TO_PRO_SUCCESS:
            return { loading: false, success: true, userInfo: action.payload }
        case USER_UPDATE_TO_PRO_FAIL:
            return { loading: false, error: action.payload }
        case USER_UPDATE_TO_PRO_RESET:
            return {}
        default:
            return state
    }
